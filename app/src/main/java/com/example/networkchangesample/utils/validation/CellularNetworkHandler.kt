...
class CellularNetworkHandler : BaseNetworkHandler() {

    override val currentValue: NetworkService.NetworkClass = NetworkService.NetworkClass.CellularEnabled
    ...
    override fun canHandle(data: Context): Boolean {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            with(data.connectivityManager.activeNetworkInfo) {
                this?.type == android.net.ConnectivityManager.TYPE_MOBILE && isConnected
            }
        }
    }
}